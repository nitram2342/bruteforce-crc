...
BOOST_AUTO_TEST_CASE(crcFourteen)
{
	...
	bf_crc::crc_model_t model(0x0805, 0x0000, 0x0000, true, true, my_crc_basic::AUTO);
...
BOOST_AUTO_TEST_CASE(crcThirtyTwo)
{
	...
	bf_crc::crc_model_t model(0x04c11db7, 0xffffffff, 0xffffffff, false, false, my_crc_basic::AUTO);
